...
public class ViewAllProduct_RecyclerAdapter extends RecyclerView.Adapter<ViewAllProduct_RecyclerAdapter.ViewAllProduct_ViewHolder>{
    ...
    public ViewAllProduct_RecyclerAdapter(Context context,AddRemoveProductWishlist_Interface addRemoveProductWishlist) {
    ...
    @NonNull
    @Override
    public ViewAllProduct_RecyclerAdapter.ViewAllProduct_ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.hub_product_cardview_layout, parent, false);
        return new ViewAllProduct_RecyclerAdapter.ViewAllProduct_ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewAllProduct_RecyclerAdapter.ViewAllProduct_ViewHolder holder, int position) {
    ...
    public class ViewAllProduct_ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewAllProduct_ViewHolder(@NonNull View itemView) {
            super(itemView);
