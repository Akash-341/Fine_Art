...
public class CustomCircularProgressView extends View {
    ...
    private List<com.ort.fineart.Utils.CircularProgressViewListener> listeners;
    ...
    private void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(R.styleable.CustomCircularProgressView_cpv_color)) {
            color = a.getColor(R.styleable.CustomCircularProgressView_cpv_color, ResourcesCompat
                    .getColor(resources, R.color.cpv_default_color, null));
        }
    ...
    public void setIndeterminate(boolean isIndeterminate) {
        ...
        if (old != isIndeterminate) {
            for (com.ort.fineart.Utils.CircularProgressViewListener listener : listeners) {
     ...
     */
    public void addListener(com.ort.fineart.Utils.CircularProgressViewListener listener) {
        if (listener != null)
     ...
     */
    public void removeListener(com.ort.fineart.Utils.CircularProgressViewListener listener) {
