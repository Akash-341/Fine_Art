...
public class OrderHistory_ResponseModel {
    private int id;
    private int OrderId;
    ...
    public ArrayList<OrderHistory_ProductDetail_ResponseModel> getProducts() {
        return products;
    }

    public void setProducts(ArrayList<OrderHistory_ProductDetail_ResponseModel> products) {
        this.products = products;
    }
}
