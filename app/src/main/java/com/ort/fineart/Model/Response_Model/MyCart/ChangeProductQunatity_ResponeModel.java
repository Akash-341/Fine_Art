...
public class ChangeProductQunatity_ResponeModel {
    private int id;
    ...
    public ChangeProductQunatity_ResponeModel(int id, String customer, int varientProductId, int varientId, String date, String varientColor, String varientSize, int varientPrice, int varientQuantity, int varientDiscountPrice, int varientDiscount, String varientDiscountMode, int varientWeight, int varientTotalWeight, int varientTotalWithoutDiscount, int varientTotalWithDiscount, boolean isactive) {
        this.id = id;
