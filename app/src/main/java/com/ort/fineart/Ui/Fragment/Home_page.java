...
//                toggleWishlist(position);
      ...
      /*  bestsellerLiveData.observe(getViewLifecycleOwner(), new Observer<List<com.ort.fineart.Model.Response_Model.Best_Seller.Payload>>() {
        ...
        binding.dotdViewAll.setOnClickListener(view -> {
            ...
            transaction.setCustomAnimations(R.anim.slide_in_right_fade, R.anim.slide_out_left_fade, R.anim.slide_in_left_fade, R.anim.slide_out_right_fade);
            transaction.replace(R.id.main_container, fragmentB);
            transaction.addToBackStack(null); // Optional: Adds the transaction to the back stack
            transaction.commit();
        });
        binding.bestSellerViewAll.setOnClickListener(view -> {
            BestSeller_ViewAll fragmentB = new BestSeller_ViewAll();
